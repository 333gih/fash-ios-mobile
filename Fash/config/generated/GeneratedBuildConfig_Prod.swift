// Generated from env/prod.env — re-run scripts/env_to_xcconfig.py
import Foundation
...
enum GeneratedBuildConfig_Prod {
    ...
    static let CORE_API_USE_LANGUAGE_PREFIX: Bool = true
    static let AUTH_API_USE_LANGUAGE_PREFIX: Bool = true
    static let SHIPPING: Bool = true
    static let SKIP_SIZING_REFERENCE_COMPLETED: Bool = false
}
