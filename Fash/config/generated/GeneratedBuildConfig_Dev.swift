// Generated from env/dev.env — mirrors Android BuildConfig injectFromEnv
import Foundation

enum GeneratedBuildConfig_Dev {
    static let environmentName: String = "dev"
    static let flavor: String = "dev"
    static let bundleId: String = "com.pc.fash-ios-mobile.dev"
    ...
    static let paymentRedirectURL: String = "https://fash.app/payment/callback"
    static let identityReverifyURL: String = ""
    static let imageResizeBaseURL: String = "http://76.13.211.193:9003"
    ...
    static let appleLoginEnabled: Bool = true
