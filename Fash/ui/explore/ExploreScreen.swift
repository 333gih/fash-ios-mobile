...
struct ExploreScreen: View {
    ...
    private let collapseScrollThreshold: CGFloat = 88
    ...
    private var showCompactChrome: Bool {
        scrollOffset > collapseScrollThreshold
    }
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            if viewModel.searchBarExpanded && !viewModel.isSearchModeActive {
                ...
                .animation(.easeInOut(duration: 0.24), value: showCompactChrome)
            }
